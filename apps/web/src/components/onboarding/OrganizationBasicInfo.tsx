	...
	useEffect(() => {
		if (cnpjQuery.data) {
			...
			if (data.nomeFantasia) {
				form.setFieldValue("slug", data.nomeFantasia.toLowerCase().replace(/\s+/g, "-"));
								...
								<div className="space-y-3">
									...
									<div className="flex gap-2">
										<Input
											...
											classNames={{
												input: "text-sm",
												inputWrapper: "bg-white border-gray-200 hover:border-gray-300 focus-within:border-primary",
											}}
											maxLength={18}
										/>
										<Button
						...
						{(field) => (
							<div className="space-y-2">
								...
								<Input
									...
									classNames={{
										input: "text-sm",
										inputWrapper: "bg-white border-gray-200 hover:border-gray-300 focus-within:border-primary h-11",
									}}
								/>
